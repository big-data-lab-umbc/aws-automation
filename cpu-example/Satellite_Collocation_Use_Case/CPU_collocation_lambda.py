...
credentials = ["","",""]   #region,access_key,secret_key
...
def lambda_handler(event, context):
    ...
    send_command_to_master(masterInstanceId,\
        "aws s3 cp /home/ubuntu/satellite_collocation_sample_data/collocation-output s3://ai-4-atmosphere-remote-sensing/collocation-output --recursive",\
        ssm_client)
    print(event)
    # print(context)
